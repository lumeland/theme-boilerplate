...
## [0.3.1] - 2026-02-08
### Changed
- Added `.gitattributes` file to publish on Jsdelivr.
- Ignored README.md for `deno fmt` since it's formatted by keep-a-changelog
...
[0.3.1]: https://github.com/lumeland/theme-boilerplate/compare/v0.3.0...v0.3.1
